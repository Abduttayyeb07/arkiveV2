<script lang="ts">
	...
	import { ARKIVE_BUILD_HASH, ARKIVE_VERSION } from '$lib/constants';
		...
		{#if adminConfig !== null}
			<div class="">
						...
						<div class="flex w-full justify-between items-center">
							<div class="flex flex-col text-xs text-gray-700 dark:text-gray-200">
								<div class="flex gap-1">
									<Tooltip content={ARKIVE_BUILD_HASH}>
										v{ARKIVE_VERSION}
									</Tooltip>

									{#if $config?.features?.enable_version_update_check}
										<a
											href="https://github.com/Abduttayyeb07/ArkiveV2IA/releases/tag/v{version.latest}"
											target="_blank"
										>
											{updateAvailable === null
						...
						<div class="flex w-full justify-between items-center">
							<div class="text-xs pr-2">
								...
								<div class=" text-xs text-gray-500">
									{$i18n.t('Discover how to use Arkive and seek support from the community.')}
								</div>
							</div>
						...
						<div class="mt-1">
							<div class="flex space-x-1">
								<a href="https://discord.gg/5rJgQTnV4s" target="_blank">
									<img
										alt="Discord"
										src="https://img.shields.io/badge/Discord-Arkive-blue?logo=discord&logoColor=white"
									/>
								</a>

								<a href="https://github.com/Abduttayyeb07" target="_blank">
									<img
										alt="X (formerly Twitter) Follow"
										src="https://img.shields.io/github/stars/Abduttayyeb07/ArkiveV2IA"
									/>
								</a>

								<a href="https://github.com/Abduttayyeb07/ArkiveV2IA" target="_blank">
									<img
										alt="Github Repo"
										src="https://img.shields.io/github/stars/Abduttayyeb07/ArkiveV2IA?style=social&label=Star us on Github"
									/>
								</a>
							</div>
						</div>
				...
				<div class="mb-3">
					...
					<div class="mb-2.5 w-full justify-between">
						<div class="flex w-full justify-between">
							<div class=" self-center text-xs font-medium">{$i18n.t('Arkive URL')}</div>
						</div>
						...
						<div class="flex mt-2 space-x-2">
							<input
								...
								bind:value={adminConfig.ARKIVE_URL}
							/>
						</div>

						<div class="mt-2 text-xs text-gray-400 dark:text-gray-500">
							{$i18n.t(
								'Enter the public URL of your Arkive. This URL will be used to generate links in the notifications.'
							)}
						</div>
					</div>
