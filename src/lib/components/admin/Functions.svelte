<script lang="ts">
	...
	const shareHandler = async (func) => {
		...
		toast.success($i18n.t('Redirecting you to Arkive Community'));

		const url = 'https://github.com/Abduttayyeb07/ArkiveV2IA';
		...
		{#if $config?.features.enable_community_sharing}
			<div class=" my-16">
				...
				<a
					...
					href="https://github.com/Abduttayyeb07/ArkiveV2IA/functions"
					target="_blank"
				>
