<script lang="ts">
	...
	export let imageUrls = [
		`${ARKIVE_BASE_URL}/assets/images/adam.jpg`,
		`${ARKIVE_BASE_URL}/assets/images/galaxy.jpg`,
		`${ARKIVE_BASE_URL}/assets/images/earth.jpg`,
		`${ARKIVE_BASE_URL}/assets/images/space.jpg`
	];
