...
from arkive.internal.db import get_session, SessionLocal
...
from arkive.routers.retrieval import ProcessFileForm, process_file
from arkive.routers.audio import transcribe
...
from arkive.utils.misc import strict_match_mime_type
...
def upload_file_handler(
    ...
    try:
        ...
        contents, file_path = Storage.upload_file(
            ...
            filename,
            {
                'Arkive-User-Email': user.email,
                'Arkive-User-Id': user.id,
                'Arkive-User-Name': user.name,
                'Arkive-File-Id': id,
            },
        )
