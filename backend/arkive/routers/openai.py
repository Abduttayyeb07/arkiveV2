...
from arkive.utils.payload import (
...
from arkive.utils.anthropic import is_anthropic_url, get_anthropic_models
...
async def get_headers_and_cookies(
    ...
    headers = {
        ...
        **(
            {
                'HTTP-Referer': 'https://github.com/Abduttayyeb07/ArkiveV2IA',
                'X-Title': 'Arkive',
            }
    ...
    try:
        ...
        try:
            ...
            raise HTTPException(
                ...
                detail=detail if detail else 'Arkive: Server Connection Error',
            )
    ...
    if url_idx is None:
        ...
        async with aiohttp.ClientSession(
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail='Arkive: Server Connection Error')
            except Exception as e:
...
def _normalize_stored_item(item: dict) -> dict:
    ...
    Arkive stores extra bookkeeping fields (``id``, ``status``,
...
async def generate_chat_completion(
    ...
    try:
        ...
        raise HTTPException(
            ...
            detail='Arkive: Server Connection Error',
        )
    finally:
        if not streaming:
