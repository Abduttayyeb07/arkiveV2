...
from arkive.retrieval.web.main import SearchResult, get_filtered_results
from arkive.utils.headers import include_user_info_headers
from arkive.env import FORWARD_SESSION_INFO_HEADER_CHAT_ID
...
def search_yandex(
    ...
    try:
        headers = {
            'User-Agent': 'Arkive (https://github.com/Abduttayyeb07/ArkiveV2IA) RAG Bot',
